...
H = N + N//2 # RECORDAR: el H=N+1 es el MÍNIMO para que funcione
M = 1
...
#    model.zero_grad() # tengo que resetear el gradiente antes de recalcular los pesos
    ...
    error = costf(y,z) # calculo el torch.cuda.is_available()rror entre target y modelo
...
print("Error generalización", Ep.item()) #Es muy malo!